...
var mode = "dark"; // light or dark
var skinColor = "danger"; // Skin Palette
...
function setSkinListHeightAndScroll(isFirstTime) {
  var height = $(window).height() - ($(".navbar").innerHeight() + $(".theme-palette .nav-tabs").outerHeight());
...
function initializePalette() {
  ...
  $(".theme-color > label").click(function (e) {
    ...
    $("body").removeClass();
    $("body").addClass(`${theme} submenu-closed menu_${theme} logo-${colorObject[theme]} theme-${colorObject[theme]}`);
