...
class TableControl
{
  ...
  public function update_generic_tables()
  {
    ...
    $query8 = "REPLACE into {$admin->table}({$admin->primary_key}, {$admin->username_col}, {$admin->password_col}, {$admin->name_col}, {$admin->last_name_col}, role, access_level, status, {$admin->email_col}, type) values ('1','administrator','password@admin','John','Doe','1','2','1','info@ugoson.com', '1')";
